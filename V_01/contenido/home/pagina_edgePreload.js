...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "js/interfaz_contenido.js", user: true },
      { load: "pagina_edge.js"},
      { load: "pagina_edgeActions.js"}];
...
var plSTF="width",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="980px",plHeight="643px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['459', '313','62px','18px','auto', 'auto'],
